...
1. Answering questions about your configuration, for example: "What are the internal and external ports that are in use by my service?"
2. Make changes to your configuration: "Change the host address of my dev environment to my-domain.com".
3. Help me debug errors in production. For example, try asking it about the log below. After it provides the log analysis, ask it to increase your CPU resources by 50%. Example Log Message: 
...
<Frame>
![ChatOps Example](/chatops/img/chatops-example.png) 
</Frame>
